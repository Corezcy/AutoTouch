...
import com.zheng.autotouch.fw_permission.FloatWinPermissionCompat;
import com.zheng.autotouch.service.AutoTouchService;
import com.zheng.autotouch.service.FloatingService;
import com.zheng.autotouch.utils.AccessibilityUtil;
...
public class MainActivity extends AppCompatActivity {
  ...
  private void checkState() {
    boolean hasAccessibility =
        AccessibilityUtil.isSettingOpen(AutoTouchService.class, MainActivity.this);
  ...
  private void requestAcccessibility() {
    new AlertDialog.Builder(this)
        .setTitle("无障碍服务未开启")
        .setMessage(
            "你的手机没有开启无障碍服务，" + getString(R.string.app_name) + "将无法正常使用")
