...
public class WindowUtils {
  ...
  public static void enterFullScreen(Context context, View view) {
    ...
    // 找到父布局
    ViewGroup contentView = scanForActivity(context).findViewById(android.R.id.content);
  ...
  public static WindowManager.LayoutParams newWmParams(int width, int height) {
    ...
    params.flags = WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL
        ...
        | WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_SCALED
